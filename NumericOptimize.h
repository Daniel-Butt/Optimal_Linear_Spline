...
private:
    static double gold_minimize(std::function<double(double)> f, std::vector<double> I, const double tol = 1e-7) {
    ...
    static double brent_minimize(std::function<double(double)> f, std::vector<double> I, const double t = 1e-7) {
        double a = I[0];
        double b = I[1];
        double c;
        double d;
    ...
    static double brent_dekker_root(std::function<double(double)> func, std::vector<double> I, const double tol = 1e-7) {
        int iter;

        double a = I[0], b = I[1], c = I[1], d, e, min1, min2;
